...
export const Footer = () => {
  return (
    <footer className='px-[3rem] py-[4rem] bg-footer laptop:pt-[17rem] laptop:px-[16rem]'>
      <div className='flex justify-center laptop:justify-between items-center laptop:flex-row gap-[3.2rem] flex-col'>
        <div>
      ...
      <div className='flex laptop:hidden justify-between mt-[6.8rem] text-[1.4rem] font-[Montserrat-SemiBold]'>
        <p>T: +2347040119703</p>
        <p>E: hello@mvx.trade</p>
      </div>

      <div className='flex laptop:hidden justify-center gap-7  flex-col items-center mt-[1.7rem] text-[1.4rem]'>
