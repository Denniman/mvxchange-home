...
export const Hero = () => {
  return (
    <section className="py-[3.4rem] rounded-b-[1rem] laptop:px-[16rem] rounded-r-[1rem] px-[1.6rem] bg-cover bg-center bg-bgNav bg-[url('https://res.cloudinary.com/dn8vprize/image/upload/v1659093697/subtract_e6ak5a.svg')]">
      ...
      <article className='round mt-[5rem] tablet:mt-[13rem] flex items-center justify-center'>
        <iframe
      ...
      <article className='mt-[7rem]'>
        <p className='mb-[3rem] text-[1.4rem]'>Trusted by global companies</p>
      </article>

      <div className='grid grid-cols-2 laptop:grid-cols-5 gap-4 text-[1.2rem]'>
        <div>
